...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@tema_o_materia_maestra_tema_o_materia') ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('maestra_tema_o_materia/form_actions', array('tema_o_materia' => $tema_o_materia, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
